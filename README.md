...
The four ingestion RPCs follow the same privilege boundary. New revisions stay
staged until provision/chunk counts, structure, and vector dimensions pass an
atomic finalization gate; failures leave the last active revision untouched.
